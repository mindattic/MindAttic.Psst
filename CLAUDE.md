...
- SMS path: email-to-SMS carrier fanout. Creds from MindAttic.Vault (`MindAttic:Vault:Notifications`). `ISmsClient`/`PsstVia` abstraction kept for future alternative transports.
